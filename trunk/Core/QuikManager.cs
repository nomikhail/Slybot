...
using System.Threading;
using log4net;
using TestMaster.Common.WinAPI;
...
namespace Core
{
    ...
    public class LaunchQuik
    {
        ...
        //private static extern int SendMessage(int hwnd, int uMsg, int wParam, int lParam);
        ...
        //    SendMessage(loginBox.ToInt32(), WM_CHAR, 73, 0x00150001);

        //    UIHelper.SimulateKeyboardInput(loginBox, "Новицкий Михаил Дмитриевич", NativeWindowClasses.Edit);
